...
if(isset($_POST["ubah"])){
  ...
  if(mysqli_num_rows($cek) < 1){
    echo "
      <script> 
        ...
        window.location = 'e_transaksi.php';
      </script>
    ";
    die;
  }
  ...
  // query update data
  $queryInsert = mysqli_query($koneksi, "UPDATE tb_transaksi SET id_paket = $id_paket, id_outlet = $id_outlet, id_user = $id_user, id_pelanggan = $id_pelanggan, tgl_selesai = '$tgl_selesai', tgl_masuk = '$tgl_masuk', status_transaksi = '$status_transaksi', status_bayar = '$status_bayar', total_bayar = $total_bayar, berat = $berat WHERE id_transaksi = $id_transaksi ") or die(mysqli_error($koneksi));
...
// ambil data transaksi yg mau di edit
$id = $_GET["id"];
$queryDt = mysqli_query($koneksi, "SELECT * FROM tb_transaksi WHERE id_transaksi = $id");
$data = mysqli_fetch_assoc($queryDt);
                      ...
                      <div class="col-12">
                        <form action="" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <select name="id_pelanggan" id="" class="form-control">
                              <?php foreach($data_pelanggan as $dp ) : ?>
                               ...
                               <?php if($dp["id_pelanggan"] == $data["id_pelanggan"]){echo"selected";} ?>
                               >
                                 <?= $dp["nama_pelanggan"]; ?>
                               </option>
                              <?php endforeach; ?>
                          ...
                          <div class="form-group">
                            ...
                            <select name="id_outlet" id="" class="form-control">
                              <?php foreach($data_outlet as $do ) : ?>
                               ...
                               <?php if($do["id_outlet"] == $data["id_outlet"]){echo"selected";} ?>
                               >
                                 <?= $do["nama_outlet"]; ?>
                               </option>
                              <?php endforeach; ?>
                          ...
                          <div class="form-group">
                            ...
                            <select name="id_user" id="" class="form-control">
                              <?php foreach($data_user as $du ) : ?>
                               ...
                               <?php if($du["id_user"] == $data["id_user"]){echo"selected";} ?>
                               >
                                 <?= $du["nama_user"]; ?>
                               </option>
                              <?php endforeach; ?>
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="<?= $data['tgl_selesai']; ?>" name="tgl_selesai">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <select name="status_bayar" id="" class="form-control">
                              <option value="belum"
                               <?php if($data["status_bayar"] == "belum"){echo"selected";} ?>
                              >
                                belum
                              </option>
                              <option value="lunas"
                          ...
                          <div class="form-group">
                            ...
                            <select name="status_transaksi" id="" class="form-control">
                              <option value="proses"
                               <?php if($data["status_transaksi"] == "proses"){echo"selected";} ?>
                              >
                                proses
                              </option>
                              <option value="selesai"
                               <?php if($data["status_transaksi"] == "selesai"){echo"selected";} ?>
                              >
                                selesai
                              </option>
                              <option value="diambil"
                               <?php if($data["status_transaksi"] == "diambil"){echo"selected";} ?>
                              >
                                diambil
                              </option>
                            </select>
