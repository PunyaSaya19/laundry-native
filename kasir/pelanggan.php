        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <a href="t_pelanggan.php" class="btn btn-success mb-2">Tambah Data</a>
                        <table class="table table-responsive table-striped">
                          ...
                          <?php foreach($data as $d) : ?>
                           <tr>
                             ...
                             <td>
                               <a href="e_pelanggan.php?id=<?= $d['id_pelanggan']; ?>" class="btn btn-primary">
                                 Edit
                               </a> | 
                               <a href="pelanggan.php?id_hps=<?= $d['id_pelanggan']; ?>" class="btn btn-danger">
                                 hapus
                               </a>
                             </td>
                           </tr>
