...
// ambil data pelanggan yg mau di edit
$id = $_GET["id"];
$query3 = mysqli_query($koneksi, "SELECT * FROM tb_pelanggan WHERE id_pelanggan = $id");
                    ...
                    <div class="row mt-0">
                      <div class="col-12">
                        <form action="" method="post">
                          ...
                          <div class="form-group">
                            <label>alamat</label>
                            <textarea name="alamat" id=alamat rows="8" cols="40" class="form-control"><?= $data['alamat']; ?></textarea>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <select name="jenis_pelanggan" id="" class="form-control">
                              <option value="reguler" <?php if($data["jenis_pelanggan"] == "reguler"){echo"selected";} ?>>
                                Reguler
                              </option>
                              <option value="member" <?php if($data["jenis_pelanggan"] == "member"){echo"selected";} ?>>
                                Member
                              </option>
                            </select>
                          </div>
