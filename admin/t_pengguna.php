...
if(isset($_POST["tambah"])){
  ...
  $query = mysqli_query($koneksi, "INSERT INTO tb_user VALUES(NULL, '$nama_user', '$username', '$password', '$id_outlet', '$level')") or die(mysqli_error($koneksi));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h3 mb-0 text-gray-800">tambah pengguna/user</h1>
                    </div>
                    <div class="row mt-0">
                      <div class="col-12">
