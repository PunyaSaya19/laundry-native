...
if(isset($_POST["tambah"])){
  ...
  $query = mysqli_query($koneksi, "INSERT INTO tb_outlet VALUES(NULL, '$nama_outlet', '$alamat', '$telp')") or die(mysqli_error($koneksi));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h3 mb-0 text-gray-800">tambah outlet</h1>
                    </div>
                    <div class="row mt-0">
                      <div class="col-12">
