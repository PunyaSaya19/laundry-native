...
if(isset($_POST["tambah"])){
  ...
  $query = mysqli_query($koneksi, "INSERT INTO tb_pelanggan VALUES(NULL, '$nama_pelanggan', '$alamat', '$telp', '$id_outlet', '$jenis_pelanggan')") or die(mysqli_error($koneksi));
                    ...
                    <div class="row mt-0">
                      <div class="col-12">
                        <form action="" method="post">
                          ...
                          <div class="form-group">
                            <label>alamat</label>
                            <textarea name="alamat" id=alamat rows="8" cols="40" class="form-control"></textarea>
                          </div>
